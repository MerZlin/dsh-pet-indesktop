...
| [`RELEASE-v4.2.1.md`](RELEASE-v4.2.1.md) | **v4.2.0 → v4.2.1 的发布草稿**：54 个 PR / 约 175 提交的完整汇总，另含**发布前测试清单**（勾选式）与**视频预演脚本**（逐段分镜）、发布前清单（版本号 / workflow_dispatch 测试构建 / 打 tag 流程）。 | **准备发布、跑人工验收、或录制演示视频时必读**；改版本号、打 tag、或需要"这一版到底该验哪些行为"的清单时。 |
