...
> **注**（2026-09-05，批5.3 之后）：本文档为 perf/stage-1 的历史交付记录。
> 共享解码已于批5.3（2026-09-05）由**进程内帧扇出（DecodeFanoutHub）**取代，
> `decode_broker_enabled` 与 `decode_broker.py` 均已移除；下文相关描述仅作存档，
> 请以当前代码为准。
