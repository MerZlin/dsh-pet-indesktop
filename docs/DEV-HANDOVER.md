...
│   ├── modern_settings_dialog.py # 现代设置主对话框（2419 行，预算 2419）
...
| `pet/modern_settings_dialog.py` | `MODERN_SETTINGS_DIALOG_PY_LINE_BUDGET` | **2419** | 2419 |
...
| 高 | `modern_settings_dialog.py` 再拆分 | 余量 0 行（2419/2419，预算已随本轮三行控件校准到实测值）；新设置页应先拆到独立 `*_settings.py` |
